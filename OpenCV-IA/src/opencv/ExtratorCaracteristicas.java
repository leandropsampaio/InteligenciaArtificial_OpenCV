...
public class ExtratorCaracteristicas {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(diretorio.toURI());
        ...
        for (int i = 0; i < arquivos.length; i++) {
            ...
            for (int altura = 0; altura < imagemProcessada.height(); altura++) {
                for (int largura = 0; largura < imagemProcessada.width(); largura++) {
                    ...
                    if (blue >= 11 && blue <= 22
                            && green >= 85 && green <= 105
                            && red >= 240 && red <= 255) {
                        scalarImagemProcessada.blue(0);
                        scalarImagemProcessada.green(255);
                        scalarImagemProcessada.red(128);
                        // Pintar o pixel da cor escolhida
            ...
            int quantPixelsTotal = imagemOriginal.height() * imagemOriginal.width();
